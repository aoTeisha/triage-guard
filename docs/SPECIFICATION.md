...
| `no_active_duplicate`      | no open case (any control state before `case_closed`), other than this case itself, already exists for this `stable_patient_id`                                                                                                                                  | Datalog (provenance) |
